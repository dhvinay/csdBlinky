 ...
 *
 * This file describes the post-build time configuration parameters
 *
 * \b Application:        Dem \n
...
#define DEM_PBCFG_SW_MAJOR_VERSION (4U)
#define DEM_PBCFG_SW_MINOR_VERSION (20U)
#define DEM_PBCFG_SW_PATCH_VERSION (0U)
...
\*============================================================================*/
#define DEM_START_SEC_CONST_POSTBUILD_UNSPECIFIED
#include "Dem_MemMap.h" /* KW MISRA.INCL.INSIDE */

extern CONST(Dem_ConfigType, DEM_CONST) DemConfigSet;

#define DEM_STOP_SEC_CONST_POSTBUILD_UNSPECIFIED
#include "Dem_MemMap.h" /* KW MISRA.INCL.INSIDE */
