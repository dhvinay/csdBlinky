...
#define COM_ENABLE_SIGNAL_GATEWAY              (STD_ON)
#define COM_ENABLE_IPDU_CALLOUT                (STD_OFF)
#define COM_ENABLE_TMS                         (STD_ON)
...
#define COM_ENABLE_TRIGERRED_SIGNALS           (STD_ON)
#define COM_ENABLE_SIGNED_DATA                 (STD_ON)
#define COM_ENABLE_DIRECT_PACKING              (STD_ON)
...
#define COM_GROUP_VECTOR_LENGTH 4U


/* Hash key for Com Pre-Compile configuration */
#define COM_PC_HASH_VALUE ((uint32)4017878498U)
